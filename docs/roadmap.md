...
- [ ] **Surface modes on the main page** — visible mode/length switcher (Monkeytype-style top bar), not a gear-icon modal. The differentiators must be discoverable in 10 seconds
...
- [ ] **Daily challenge** — same seed text for everyone, daily leaderboard, streak integration; the recurring visit reason
