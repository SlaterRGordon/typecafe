---
name: reviewing-code
description: Performs a thorough code review focused on correctness, maintainability, performance, and best practices. Use when the user asks for a code review, feedback on their code, or to check code quality.
---
...
Read the files or diff to understand what the code is supposed to do. Identify the scope (new feature, bug fix, refactor).
