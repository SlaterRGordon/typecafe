    ...
    return (
        <div className="flex flex-col justify-center items-center w-8/12 space-y-2">
            <div className="flex justify-center w-full">
                ...
                {/* restart button */}
                <button className="btn btn-ghost btn-circle" onClick={() => setRestart(value => !value)} tabIndex={0}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M12 3a9 9 0 1 1-5.657 2"/><path d="M3 4.5h4v4"/></g></svg>
                </button>
            </div>
            <Text text={text} />
        </div>
