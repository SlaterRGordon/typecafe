    ...
    return (
        <div className="flex flex-col py-8 sm:py-0 sm:justify-center items-center mx-4 space-y-2">
            <div className="flex relative justify-center items-center w-full gap-2 max-w-screen-xl">
                ...
                {/* settings button */}
                {showConfig &&
                    <label className="btn btn-ghost btn-circle" htmlFor="configModal" aria-label="Open typing settings">
                ...
                {/* restart button */}
                <button className="btn btn-ghost btn-circle focus:outline-0" ref={restartRef} onClick={handleRestart} tabIndex={0} aria-label="Restart test">
                ...
                {/* fullscreen button */}
                <button className="btn btn-ghost btn-circle focus:outline-0" onClick={() => props.setFullscreen(!fullscreen)} aria-label={fullscreen ? "Exit fullscreen" : "Enter fullscreen"}>
                    {fullscreen ?
