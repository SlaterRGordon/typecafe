        ...
        <div className="fixed navbar z-50 bg-base-300">
            ...
            <div className="flex flex-none items-center gap-2 px-4">
                ...
                {!sessionData?.user ?
                    ...
                    :
                    <>
                        <button className="btn btn-sm gap-2 normal-case bg-base-100 text-base-content border border-base-content/20 hover:bg-base-200" aria-label="Sign out" title="Sign out" onClick={() => void signOut()}>
