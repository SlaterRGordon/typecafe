    ...
    return (
        ...
        >
            <div className="flex flex-col">
                {/* Home */}
                <button onClick={() => router.push('/')} className={getNavButtonClass('/')}>
                ...
                {/* Practise */}
                <button onClick={() => router.push('/learn')} className={getNavButtonClass('/learn')}>
                ...
                {/* Leaderboard */}
                <button onClick={() => router.push('/leaderboard')} className={getNavButtonClass('/leaderboard')}>
                ...
                {sessionData?.user &&
                    <button onClick={() => router.push('/profile')} className={getNavButtonClass('/profile')}>
                        <Avatar size={25} />
            ...
            <div className="flex flex-col">
                {/* Donate */}
                <button onClick={() => router.push('/support')} className={getNavButtonClass('/support')}>
                ...
                {/* Contact */}
                <button onClick={() => router.push('/contact')} className={getNavButtonClass('/contact')}>
                ...
                {/* Privacy Policy */}
                <button onClick={() => router.push('/privacy-policy')} className={getNavButtonClass('/privacy-policy')}>
                ...
                <button onClick={() => router.push('/terms-and-conditions')} className={getNavButtonClass('/terms-and-conditions')}>
