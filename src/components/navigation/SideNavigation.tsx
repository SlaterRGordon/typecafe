    ...
    return (
        ...
        >
            <div className="flex flex-col">
                ...
                {/* Articles */}
                <button onClick={() => router.push('/blog')} className={`btn btn-ghost m-2 flex flex-col content-start`}>
                    ...
                    <div className={`text-lg normal-case ml-2 ${isExpanded ? 'block' : 'hidden'}`}>Articles</div>
                </button>
