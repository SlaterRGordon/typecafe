    ...
    return (
        ...
        >
            <div className="flex flex-col">
                {/* Home */}
                <button onClick={() => router.push('/')} className={getNavButtonClass('/')} aria-label="Home">
                ...
                {/* Practise */}
                <button onClick={() => router.push('/learn')} className={getNavButtonClass('/learn')} aria-label="Learn">
                ...
                {/* Leaderboard */}
                <button onClick={() => router.push('/leaderboard')} className={getNavButtonClass('/leaderboard')} aria-label="Leaderboard">
                ...
                {sessionData?.user &&
                    <button onClick={() => router.push('/profile')} className={getNavButtonClass('/profile')} aria-label="Profile">
                        <Avatar size={25} />
            ...
            <div className="flex flex-col">
                {/* Donate */}
                <button onClick={() => router.push('/support')} className={getNavButtonClass('/support')} aria-label="Support">
                ...
                {/* Contact */}
                <button onClick={() => router.push('/contact')} className={getNavButtonClass('/contact')} aria-label="Contact">
                ...
                {/* Privacy Policy */}
                <button onClick={() => router.push('/privacy-policy')} className={getNavButtonClass('/privacy-policy')} aria-label="Privacy Policy">
                ...
                <button onClick={() => router.push('/terms-and-conditions')} className={getNavButtonClass('/terms-and-conditions')} aria-label="Terms">
