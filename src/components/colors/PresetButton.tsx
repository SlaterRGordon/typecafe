...
export const PresetButton = ({ name, preset, hoverStyle, setColors }: Props) => {
    ...
    return (
        <button style={{ 
            ...
            borderColor: "#878787", 
            color: preset["--bc"],
        }} className={`btn flex w-full flex-col !h-[unset] border rounded-md px-4 py-2 ${hoverStyle}`}
        ...
        >
            ...
            <div className="flex">
                ...
                <div style={{backgroundColor: preset["--bc"]}} className="aspect-square w-5 rounded-md border" />
            </div>
        </button>
    )
}
