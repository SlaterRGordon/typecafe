...
export const Navigation = () => {
    ...
    return (
        <>
            ...
            <div className="navbar bg-base-300">
                ...
                <div className="flex-none gap-2 px-4">
                    ...
                    {!sessionData?.user ?
                        ...
                        :
                        <>
                            <button className="btn btn-ghost hover:btn-ghost">
            ...
            {/* Desktop Navigation */}
            <div className="fixed flex-col w-16 h-screen bg-base-200 hidden md:flex transition-all duration-100 ease-out hover:w-64">
